...
{
    public partial class OthersAddEdit : Form
    {
        public OthersAddEdit()
        {
            InitializeComponent();
        }
        ...
        private void btnDocOwner_Click(object sender, EventArgs e)
        {
            if(btnDocOwner.Text == "Add")
            {
                try
                {
                    ...
                    {
                        con.Open();
                        string addDocAgency = "INSERT INTO docownerothers VALUES ('','" + txt_name.Text + "','" + txt_Agency.Text + "','" + txt_Address.Text + "','" + txt_ContactNo.Text + "','" + txt_Email.Text + "');";
            ...
            else if(btnDocOwner.Text == "Update")
            {
                try
                {
                    ...
                    {
                        con.Open();
                        string updateDocAgency = "UPDATE docownerothers set name ='" + txt_name.Text + "',agencyName ='" + txt_Agency.Text + "',address ='" + txt_Address.Text + "', contactNo='" + txt_ContactNo.Text + "',email ='" + txt_Email.Text + "' where docothersID=" + lblDocOwnerID.Text + ";";
